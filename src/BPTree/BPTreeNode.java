...
public abstract class BPTreeNode<T extends Comparable<T>> implements Serializable{
	...
	public BPTreeNode(int order,String column) 
	{
		indexColumn= column;
		index = nextIdx++;
		numberOfKeys = 0;
	 ...
	 * @param object the new value for the key
	 */
	public void setKey(int index, Object object) 
	{
		keys[index] = (Comparable<T>) object;
	}
	 ...
	 */
	public abstract PushUp<T> insert(T key, TupleRef recordReference, BPTreeInnerNode<T> parent, int ptr);
	
	public String getIndexColumn() {
		return indexColumn;
	}
	
	public abstract LinkedList<Tuple> smallerequalSearch(SQLTerm indexedTerm ,SQLTerm[] otherSQLTerms, String[] strarrOperators);
	
	public abstract LinkedList<Tuple> greaterequalSearch(SQLTerm indexedTerm ,SQLTerm[] otherSQLTerms, String[] strarrOperators);
	
	public abstract LinkedList<Tuple> equalSearch(SQLTerm indexedTerm ,SQLTerm[] otherSQLTerms, String[] strarrOperators);
	
	public abstract LinkedList<Tuple> notEqualSearch(SQLTerm indexedTerm ,SQLTerm[] otherSQLTerms, String[] strarrOperators);
	
	public abstract Ref search(T key);
	
	public abstract TupleRef insertLocation(T tuple);
	
//	public abstract TupleRef searchToDelete(Hashtable<String, Object> deletedColumnValues);
	
	public abstract LinkedList<TupleRef> searchToDelete(Hashtable<String, Object> deletedColumnValues);
	
	public abstract void updateTupleRef(T tuple, TupleRef tupleRef); 
	
	public abstract void printLeafNodes();
